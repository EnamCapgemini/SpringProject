...
INSERT INTO COURSE VALUES(110,'3 YEARS',DATEADD(YEAR,3,SYSDATE()),'300000','M.TECH CSE',SYSDATE());
INSERT INTO COURSE VALUES(220,'3 YEARS',DATEADD(YEAR,3,SYSDATE()),'400000','B.Sc Math',SYSDATE());
INSERT INTO COURSE VALUES(210,'3 YEARS',DATEADD(YEAR,3,SYSDATE()),'400000','B.Sc Chemistry',SYSDATE());
INSERT INTO COURSE VALUES(230,'3 YEARS',DATEADD(YEAR,3,SYSDATE()),'400000','B.Sc Physics',SYSDATE());
INSERT INTO COURSE VALUES(330,'4 YEARS',DATEADD(YEAR,4,SYSDATE()),'800000','B.TECH ME',SYSDATE());
INSERT INTO COURSE VALUES(310,'4 YEARS',DATEADD(YEAR,4,SYSDATE()),'800000','B.TECH IT',SYSDATE());
INSERT INTO COURSE VALUES(320,'4 YEARS',DATEADD(YEAR,4,SYSDATE()),'800000','B.TECH CSE',SYSDATE());
INSERT INTO COURSE VALUES(510,'2 YEARS',DATEADD(YEAR,2,SYSDATE()),'200000','B.TECH ECE',SYSDATE());


INSERT INTO ADMISSION (ADMISSION_ID,ADMISSION_DATE,APPLICANT_ID,COURSE_ID,STATUS,ADMISSION_COMMITEE_STAFF_ID) VALUES(10,SYSDATE(),4500,220,'PENDING',200);
INSERT INTO ADMISSION (ADMISSION_ID,ADMISSION_DATE,APPLICANT_ID,COURSE_ID,STATUS,ADMISSION_COMMITEE_STAFF_ID) VALUES(20,SYSDATE(),4501,210,'PENDING',500);
INSERT INTO ADMISSION (ADMISSION_ID,ADMISSION_DATE,APPLICANT_ID,COURSE_ID,STATUS,ADMISSION_COMMITEE_STAFF_ID) VALUES(30,SYSDATE(),4502,110,'PENDING',700);
INSERT INTO ADMISSION (ADMISSION_ID,ADMISSION_DATE,APPLICANT_ID,COURSE_ID,STATUS,ADMISSION_COMMITEE_STAFF_ID) VALUES(40,SYSDATE(),4503,320,'PENDING',600);
INSERT INTO ADMISSION (ADMISSION_ID,ADMISSION_DATE,APPLICANT_ID,COURSE_ID,STATUS,ADMISSION_COMMITEE_STAFF_ID) VALUES(50,SYSDATE(),4504,510,'PENDING',800);
...
INSERT INTO APPLICANT(APPLICANT_ID,ADDRESS,DEGREE,APPLICANT_FIRSTNAME,GRAD_PER,APPLICANT_LASTNAME,COURSE_ID,EMAIL_ID,GENDER,PH_NO,ADMISSION_ID) VALUES(4501,'kharagpur','10th pass','Karishma',98,'Agarwal',210,'karishma.agarwal@rediff.com','FEMALE','9934567890',20);
...
INSERT INTO APPLICANT(APPLICANT_ID,ADDRESS,DEGREE,APPLICANT_FIRSTNAME,GRAD_PER,APPLICANT_LASTNAME,COURSE_ID,EMAIL_ID,GENDER,PH_NO,ADMISSION_ID) VALUES(4504,'howrah','12th pass','Suzan',94,'Arora',510,'suzan.arora@amazon.com','FEMALE','8930266363',50);
